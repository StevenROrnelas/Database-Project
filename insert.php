...
<select id="selection" name="table" ><option></option>
    ...
    <option value="Customer">Insert into Customer table </option>
    <option value="Item">Insert into Item table </option>
    <option value="Location">Insert into Location table </option>
    <option value="LocationCustomer">Insert into LocationCustomer table </option>
    <option value="LocationItems">Insert into LocationItems table </option>
    <option value="Orders">Insert into Orders table </option>
    <option value="OrderItems">Insert into OrderItems table </option>
    <option value="OrdersLocations">Insert into OrderLocations table </option>
    <option value="Supplier">Insert into Supplier table </option>
